...
public class EgovSampleController {
    ...
    public void getDetailAddrApi(HttpServletRequest req, ModelMap model, HttpServletResponse response) throws Exception {
		...
		String apiUrl = "https://www.juso.go.kr/addrlink/addrCoordApi.do?admCd ="+admCd+"&rnMgtSn="+rnMgtSn+"&udrtYn="+udrtYn+"&buldMnnm="+buldMnnm+"&buldSlno="+buldSlno+"&searchType="+searchType+"&dongNm="+URLEncoder.encode(dongNm,"UTF-8")+"&confmKey="+confmKey;
